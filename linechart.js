...
// var tooltip = d3.select(this.parentNode).append("g");
			...
			// var content = tooltip.append("text")
			// 	.attr("x", d3.select(this).attr("cx")-toolTipWidth/2 + 12)
			// 	.attr("y", d3.select(this).attr("cy")-toolTipHeight+12)
			// 	.text("Views")
			// 	.attr("font-family", "sans-serif")
			// 	.attr("font-size", "20px");

			// var displayData = tooltip.append("text")
			// 	.attr("x", d3.select(this).attr("cx")-toolTipWidth)
			// 	.attr("y", d3.select(this).attr("cy")-toolTipHeight + 40)
			// 	.text("No Data")
			// 	.attr("font-family", "sans-serif")
			// 	.attr("font-size", "20px");

			// var textDimension= displayData.node().getBBox();
			// displayData.attr("transform", "translate(" + textDimension.width/2 + "," + "0)");
